...
CFD_LOG = CFD_DIR / "cfd.log"
# URL base per PDF CFD Regione Veneto (cambia il prefisso ogni anno)
# Pattern: {base_url}/{PREFIX}_{YYMMDD}_CFD.pdf
CFD_BASE_URL = (
    "https://www.regione.veneto.it/documents/90748/14376036"
)
CFD_PREFIXES = ["BVM", "BAR"]
...
# CHAT_ID usato solo per compatibilità legacy; il nuovo script.py
# invia le notifiche via subscriptions.py a ciascun iscritto.
...
# Chat ID a cui inviare i bollettini CFD (default: ravem)
CFD_CHAT_ID = int(os.getenv("CFD_CHAT_ID", "27459552"))
